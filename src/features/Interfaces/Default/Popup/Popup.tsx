...
const Popup: React.FC = () => {
  ...
  const [styles, setStyles] = React.useState({
    ...
    headerBar: `headerBarForPopup`,
    backToIndexPageButton: `backToIndexPageButtonForPopup`,
    switchStylesButton: `switchStylesButtonForPopup`,
  ...
  React.useEffect(() => {
    if (kindOfStyle === `colorful`) {
      ...
      setStyles((styles) => {
        return {
          ...styles,
          mainDisplaySupportClass: `mainPUDisplaySupportClassv2`,
          popupButton: `popupButtonv3`,
          closePopupButton: `closePopupButtonv2`,
        };
      });
    }
  }, [kindOfStyle]);
